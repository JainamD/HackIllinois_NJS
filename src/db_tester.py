...
person.add_quest('"Go to Mexican"', '"Get food so J does not kill me"', 0, 0, 0, 0, 0, 1, 45, 0, '"Nishka"')

print(person.get_random_quest("Jainam"))





#person.delete_quest_name('"Clean Closet"', '"Jainam"')
